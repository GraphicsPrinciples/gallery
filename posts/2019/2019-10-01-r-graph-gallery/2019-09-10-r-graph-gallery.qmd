...
description: "An online collection of graphs and charts written mainly but not exclusively written in R."
author:
...
```{r, fig.cap = "Screenshot of how examples and code are intuitively organised @ https://www.r-graph-gallery.com/index.html.", echo=FALSE}
