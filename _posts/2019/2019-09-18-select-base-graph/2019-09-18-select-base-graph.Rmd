...
Multiple examples from the graphics principles cheatsheet section: selecting the right base graph.

This plot is taken from the Graphics principles cheat sheet, section: “Selecting the right base graph”.

Consider if a standard graph can be used by identifying suitable designs based on the: (i) purpose (i.e. message to be conveyed or question to answer) and (ii) data (i.e. variables to display).
