...
```{r, echo = FALSE, cap = "A line plot of six treatment time courses."}
...
If it is not possible to limit the number of comparisons to four or less groups, consider using a panel of graphs (i.e. small multiple graphs on the same scale). This strategy allows all information to be presented on one graph, focusing each comparison of interest to a single panel. 
...
Below is the code required to reproduce these plots used in this post. 
