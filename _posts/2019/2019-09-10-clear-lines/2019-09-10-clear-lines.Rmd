...
```{r, preview=TRUE, fig.cap = "An example of using small multiples or a trellis plot. The full data is displayed in a lighter colour and is pushed in to the background. For each panel, one treatment is highlighted and put in to focus (using a stronger colour). This allows for comparisons by treatment, while introducing less cluter in to the visualisation."}
